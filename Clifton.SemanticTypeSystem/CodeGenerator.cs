...
namespace Clifton.SemanticTypeSystem
{
	public static class CodeGenerator
	{
		...
		/// </summary>
		public static string Generate(Dictionary<string, ISemanticType> SemanticTypes)
		{
			...
			{
				// Classes
				ISemanticTypeStruct ststruct = st.Decl.OfType;
				...
				sb.AppendLine("\tpublic class " + ststruct.DeclTypeName + " : IRuntimeSemanticType");
				sb.AppendLine("\t{");
				...
				if (ststruct.HasSemanticTypes)
				{
					sb.AppendLine("\t\t\t//Semantic type initializers.");
					foreach (SemanticElement selem in ststruct.SemanticElements)
					{
				...
				if (ststruct.HasSemanticTypes)
				{
					foreach (SemanticElement selem in ststruct.SemanticElements)
					{
						...
						ISemanticType stChild = SemanticTypes.Single(s => s.Value.Struct.DeclTypeName == selem.Name).Value;
